...
const CATEGORIES = [
  ...
  },
  {
    ...
    intro:
      "Une couche de gel travaillée sur l'ongle naturel pour le renforcer, le protéger et l'embellir — sans capsules.",
    duration: "1 h 15 – 2 h",
    image: null,
    flat: null,
    highlights: [
  ...
  },
  {
    ...
    intro:
      "Le BIAB est un gel de construction souple et autolissant, parfait pour renforcer l'ongle naturel sans agresser.",
  ...
  },
  {
    ...
    intro:
      "Personnalisez votre pose avec des finitions couture : strass posés un à un, chrome miroir, french élégante.",
  ...
  },
  {
    ...
    intro:
      "Une dépose réalisée dans les règles pour préserver l'ongle naturel — limage doux, soin réparateur et conseils personnalisés.",
    duration: "30 – 45 min",
    image: null,
    flat: null,
    highlights: [
    ...
    care: [
      "Ne pas arracher la pose à la maison.",
