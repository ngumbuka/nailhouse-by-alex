...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Atelier d'onglerie boutique à Yaoundé. Manucure, pédicure, semi-permanent, gel, BIAB." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: ASSETS.burgundyManicure },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "NailHouse — For the beauty of nails" },
      { name: "twitter:description", content: "Atelier d'onglerie boutique à Yaoundé." },
