  ...
  return (
    <SiteLayout>
      <section className="mx-auto max-w-7xl px-4 py-8 lg:py-12">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-gold/15 pb-6 mb-6">
          <div>
        ...
        <div className="flex lg:hidden items-center justify-between p-4 mb-6 bg-card border border-border/80 rounded-2xl shadow-sm">
          <div className="flex items-center gap-2">
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              <SheetTrigger asChild>
                <Button variant="outline" size="icon" className="h-9 w-9 rounded-xl border-gold/30">
                  <Menu className="h-4.5 w-4.5 text-gold" />
                </Button>
              </SheetTrigger>
              <SheetContent side="left" className="w-64 bg-card p-6 border-r border-border">
                <SheetHeader className="mb-6 pb-4 border-b border-border/50">
                  <SheetTitle className="font-serif text-lg text-primary text-left">
                    Administration
                  </SheetTitle>
                </SheetHeader>
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all cursor-pointer ${
                          isActive
                            ? "bg-gold/10 text-gold border border-gold/25 font-semibold"
                            : "text-muted-foreground hover:text-foreground hover:bg-muted/10 border border-transparent"
                        }`}
                      >
                        <Icon
                          className={`h-4.5 w-4.5 shrink-0 ${isActive ? "text-gold" : "text-muted-foreground"}`}
                        />
                        <span>{tab.label}</span>
                      </button>
                    );
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <aside
            className={cn(
              "hidden lg:flex flex-col border border-border bg-card p-4 rounded-2xl shadow-sm transition-all duration-300 shrink-0 sticky top-24",
          ...
          >
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-border/50">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 ml-auto text-muted-foreground hover:text-foreground cursor-pointer rounded-lg hover:bg-muted/20"
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all cursor-pointer border border-transparent",
                      isActive
                              ...
                              <TableCell className="font-serif text-primary font-semibold">
                                <div className="flex flex-col gap-1.5">
                                  ...
                                  <div className="flex flex-wrap gap-1">
                                    {(() => {
                                      const validation = validateWhatsAppNumber(
                                        b.phone || "",
                                        false,
                                      );
                                      return validation.isValid ? (
                                        <Badge className="font-sans bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/15 border-emerald-500/20 w-fit text-[9px] font-semibold py-0.5 px-2 rounded-full uppercase tracking-wider flex items-center gap-1">
                                          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse shrink-0" />
                                          WhatsApp
                                        </Badge>
                                      ) : (
                                        <Badge className="font-sans bg-amber-500/10 text-amber-600 hover:bg-amber-500/15 border-amber-500/20 w-fit text-[9px] font-semibold py-0.5 px-2 rounded-full uppercase tracking-wider flex items-center gap-1">
                                    ...
                                    {b.followup_preference && (
                                      <Badge
                                        className={`font-sans w-fit text-[9px] font-semibold py-0.5 px-2 rounded-full uppercase tracking-wider flex items-center gap-1 border ${
                                        ...
                                        <div className="flex flex-wrap gap-2 sm:gap-3">
                                          <Button
                                            ...
                                            onClick={(e) => {
                                              e.stopPropagation();
                                              if (
                                                confirm("Annuler définitivement ce rendez-vous ?")
                                              ) {
                                                saveDetailsMut.mutate({
                                                  id: b.id,
                                                  status: "cancelled",
              ...
              <TabsContent value="configuration" className="animate-in fade-in duration-300">
                <div className="grid gap-8 lg:grid-cols-2 items-start">
                  ...
                  >
                    ...
                    <div className="space-y-1.5">
                      <Label htmlFor="cfgBuffer">
                        Temps de battement entre chaque RDV (minutes)
                      </Label>
                      <Input
                        id="cfgBuffer"
                        type="number"
